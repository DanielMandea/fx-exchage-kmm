...
@property (readonly) SharedFxRepository *fxRepository __attribute__((swift_name("fxRepository")));
@property (readonly) SharedMuseumRepository *museumRepository __attribute__((swift_name("museumRepository")));
@end

__attribute__((swift_name("FxApi")))
@protocol SharedFxApi
@required
...
*/
- (void)getDataWithCompletionHandler:(void (^)(NSArray<SharedFxObject *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getData(completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FxObject")))
@interface SharedFxObject : SharedBase
- (instancetype)initWithId:(NSString *)id from:(NSString *)from to:(NSString *)to value:(double)value date:(NSString *)date multiplier:(NSString *)multiplier __attribute__((swift_name("init(id:from:to:value:date:multiplier:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFxObjectCompanion *companion __attribute__((swift_name("companion")));
- (SharedFxObject *)doCopyId:(NSString *)id from:(NSString *)from to:(NSString *)to value:(double)value date:(NSString *)date multiplier:(NSString *)multiplier __attribute__((swift_name("doCopy(id:from:to:value:date:multiplier:)")));
...
@property (readonly) NSString *multiplier __attribute__((swift_name("multiplier")));
@property (readonly) NSString *to __attribute__((swift_name("to")));
@property (readonly) double value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FxObject.Companion")))
@interface SharedFxObjectCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFxObjectCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FxRepository")))
@interface SharedFxRepository : SharedBase
- (instancetype)initWithFxApi:(id<SharedFxApi>)fxApi fxStorage:(id<SharedFxStorage>)fxStorage __attribute__((swift_name("init(fxApi:fxStorage:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(NSString *)objectId __attribute__((swift_name("getObjectById(objectId:)")));
...
__attribute__((swift_name("FxStorage")))
@protocol SharedFxStorage
@required
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(NSString *)objectId __attribute__((swift_name("getObjectById(objectId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveObjectsNewObjects:(NSArray<SharedFxObject *> *)newObjects completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveObjects(newObjects:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InMemoryFxStorage")))
@interface SharedInMemoryFxStorage : SharedBase <SharedFxStorage>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId:(NSString *)objectId __attribute__((swift_name("getObjectById(objectId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorFxApi")))
@interface SharedKtorFxApi : SharedBase <SharedFxApi>
...
@property (class, readonly, getter=companion) SharedKtorFxApiCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KtorFxApi.Companion")))
@interface SharedKtorFxApiCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKtorFxApiCompanion *shared __attribute__((swift_name("shared")));
@end

__attribute__((swift_name("MuseumStorage")))
@protocol SharedMuseumStorage
@required
- (id<SharedKotlinx_coroutines_coreFlow>)getObjectByIdObjectId_:(int32_t)objectId __attribute__((swift_name("getObjectById(objectId_:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getObjects __attribute__((swift_name("getObjects()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveObjectsNewObjects:(NSArray<SharedMuseumObject *> *)newObjects completionHandler_:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("saveObjects(newObjects:completionHandler_:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FxDetailViewModel")))
@interface SharedFxDetailViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)initWithFxRepository:(SharedFxRepository *)fxRepository __attribute__((swift_name("init(fxRepository:)"))) __attribute__((objc_designated_initializer));
...
- (void)setIdObjectId:(NSString *)objectId __attribute__((swift_name("setId(objectId:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FxListViewModel")))
@interface SharedFxListViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)initWithFxRepository:(SharedFxRepository *)fxRepository __attribute__((swift_name("init(fxRepository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithCloseables:(SharedKotlinArray<id<SharedKotlinAutoCloseable>> *)closeables __attribute__((swift_name("init(closeables:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MuseumDetailViewModel")))
@interface SharedMuseumDetailViewModel : SharedKmp_observableviewmodel_coreViewModel
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MuseumListViewModel")))
@interface SharedMuseumListViewModel : SharedKmp_observableviewmodel_coreViewModel
- (instancetype)initWithMuseumRepository:(SharedMuseumRepository *)museumRepository __attribute__((swift_name("init(museumRepository:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithCloseables:(SharedKotlinArray<id<SharedKotlinAutoCloseable>> *)closeables __attribute__((swift_name("init(closeables:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@interface SharedFxDetailViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^museumObjectFlow)(SharedKotlinUnit *(^)(SharedFxObject * _Nullable, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("museumObjectFlow")));
@property (readonly) SharedFxObject * _Nullable museumObject __attribute__((swift_name("museumObject")));
@end

@interface SharedFxListViewModel (Extensions)
@property (readonly) SharedKotlinUnit *(^(^objectsFlow)(SharedKotlinUnit *(^)(NSArray<SharedFxObject *> *, SharedKotlinUnit *(^)(void), SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError * _Nullable, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void) __attribute__((swift_name("objectsFlow")));
@property (readonly) NSArray<SharedFxObject *> *objects __attribute__((swift_name("objects")));
@end

@interface SharedMuseumDetailViewModel (Extensions)
...
@interface SharedMuseumListViewModel (Extensions)
