...
- (instancetype)initWithId:(NSString *)id from:(NSString *)from to:(NSString *)to value:(double)value date:(NSString *)date multiplier:(int32_t)multiplier __attribute__((swift_name("init(id:from:to:value:date:multiplier:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFxObjectCompanion *companion __attribute__((swift_name("companion")));
- (SharedFxObject *)doCopyId:(NSString *)id from:(NSString *)from to:(NSString *)to value:(double)value date:(NSString *)date multiplier:(int32_t)multiplier __attribute__((swift_name("doCopy(id:from:to:value:date:multiplier:)")));
